...
//
// Share
WebUI.waitForElementVisible(findTestObject('Page_KnovioLibrary/span_Share_presentation_852'), GlobalVariable.shortWait)
...
WebUI.verifyElementAttributeValue(findTestObject('EmbededCode/a_Get Embed Code_btn852'), 'style', 'display: none;', 10)
